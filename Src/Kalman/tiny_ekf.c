...
int ekf_step(void * v, double * z) {
    ...
    mulmat(ekf.P, ekf.Ht, ekf.tmp1, n, n, m);
    mulmat(ekf.H, ekf.P, ekf.tmp2, m, n, n);
    ...
    add(ekf.x, ekf.tmp2, ekf.x, n);

    /* P_k = (I - G_k H_k) P_k */
    mulmat(ekf.G, ekf.H, ekf.tmp0, n, m, n);
    negate(ekf.tmp0, n, n);
    mat_addeye(ekf.tmp0, n);
    mulmat(ekf.tmp0, ekf.P, ekf.tmp6, n, n, n);
...
int Riccati(void * v) {
    ...
    /* Pdot = AP+PA^T */
    mulmat(ekf.F, ekf.P, ekf.tmp6, n, n, n);
    transpose(ekf.F, ekf.Ft, n, n);
    mulmat(ekf.P, ekf.Ft, ekf.Pdot, n, n, n);
    accum(ekf.Pdot, ekf.tmp6, n, n);
    accum(ekf.Pdot, ekf.Q, n, n);
    return 0;
}